...
```c++
        ...
        uintptr_t local_player = driver::read<uintptr_t>(driver::base_address + 0x18ECF84); // just read the player data or whatever, the cr3 handling is done through the driver
